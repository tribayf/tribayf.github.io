...
NMP performed a piece incorporating contemporary dance, projection mapping, and, for my part, live sound manipulation in which the room sound was fed into a chaotic array of feedback delays + granulator. Unfortunately we neglected get somebody to film for us. But you can try out my performance [patch](/assets/img/portfolio/rewired/max.zip) if you have Max installed. I've also included a sample of what the patch is capable of below.
...
{%
    include image.html
    uri="/assets/img/portfolio/rewired/rewired-ticket.jpg"
    alt="Rewired Ticket"
    clickable=true
%}
